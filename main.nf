...
params.ref = "/proj/nobackup/breedmap/REF/ARS-UCD1.2_Btau5.0.1Y.fa.gz"
reads_raw = channel.fromFilePairs('/proj/nobackup/breedmap/DATA/kihara/SH-2271-SE-467_S18_L004_*{1,2}.fastq.gz')
params.outdir = "/proj/nobackup/breedmap/kihara/tmp_results"
params.REF = "/proj/nobackup/breedmap/REF/ARS-UCD1.2_Btau5.0.1Y.fa.gz"
